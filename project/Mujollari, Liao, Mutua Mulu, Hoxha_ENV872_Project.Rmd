...
### Multiple Linear Regression Results (notes: multiple linear regression might be suitable if we have other variables such as popolation, policy changes, etc.)
...
```{r Boxplots, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 8. Distribution of Pollutant Levels across States",fig.width = 12, fig.align='center'}
