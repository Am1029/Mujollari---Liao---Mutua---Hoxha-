...
```{r Table: Dataset Information, echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Table: Dataset Information for the Sample Period 2001 - 2021"}
...
info_table<-knitr::kable(dataset_info)%>%
...
```{r Visualization: Installed Capacity,echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Figure. Annual Installed Generation Capacity: Solar and Wind (MW)",out.height="30%"}
...
```{r Visualization: Annual Generation,echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Figure. Annual Solar and Wind Energy Generation over time (TWh)",out.height="30%"}
...
```{r Visualization: Monthly Generation,echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Figure. Monthly Renewable Energy Generation per State (TWh)",out.height="30%"}
...
```{r Visualization: Exploratory Spatial, echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Figure. Solar and Wind Power Plants Locations", out.width="100%"}
...
```{r Create GIF, echo=FALSE, message=FALSE, warning=FALSE,fig.show="hold",fig.cap="Figure. Solar and Wind Power Plant Locations"}
...
```{r Visualization: SO2, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold",fig.cap="SO2 Concentration", out.width="50%"}
...
```{r Visualization: CO, eval=FALSE, fig.cap="CO Concentration", fig.show="hold", message=FALSE, warning=FALSE, include=FALSE, out.width="50%"}
