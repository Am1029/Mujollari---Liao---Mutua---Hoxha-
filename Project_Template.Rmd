...
```{r Visualization: Exploratory Spatial, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
...
# Create GIF
CA_gif <- animate(animated_map_CA, width = 300, height = 300) #notes: error message, Error: arguments have different crs
